      ...
      features: [
        {
          ...
          description: { en: 'Transactions, guards, events, and history operate on one explicit document model.' },
          icon: 'lucide:terminal-square'
        },
        {
          title: { en: 'Rendering stays yours' },
          description: { en: 'Use the built-in renderer or provide custom node visuals without forking the engine.' },
          icon: 'lucide:panel-top'
        },
        {
          title: { en: 'Composable features' },
          description: { en: 'Connections, minimap, history, persistence, and Nuxt integration remain focused packages.' },
          icon: 'lucide:network'
        }
      ]
    }
