...
| `editing` | `boolean` | Whether the node is in text editing mode (double-click triggered). |
| `beginEdit` | `() => void` | Enter editing mode programmatically. |
| `commitText` | `(text: string) => void` | Commit edited text and exit editing mode. |
