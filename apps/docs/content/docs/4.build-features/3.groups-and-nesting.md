...
- [Nodes](/docs/understand-the-system/nodes-and-hierarchy) for `BoardNode`, `NodeInput`, and `NodePatch`.
- [Selection](/docs/build-features/selection-and-keyboard) for multi-select behavior.
- [API Reference](/docs/reference/board-core) for hierarchy helpers.
