...
- [Vue board — BoardRoot](/docs/reference/vue-board#boardroot) for LOD details
- [How Vue Board works — Four boundaries](/docs/evaluate/how-vue-board-works#four-boundaries) for the rendering architecture
