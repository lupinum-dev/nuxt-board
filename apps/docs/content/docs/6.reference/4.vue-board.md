...
- [Composables reference](/docs/reference/vue-composables) for `useBoardEngine`, `useCamera`, `useNode`, etc.
- [Engine API reference](/docs/reference/board-core) for the `BoardEngine` interface
- [Renderers guide](/docs/build-features/custom-node-renderers) for custom renderer patterns
