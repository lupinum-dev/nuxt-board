...
- [Engine API reference](/docs/reference/board-core) for camera methods on `BoardEngine`
- [Types reference](/docs/reference/board-core-types) for `Bounds`, `Camera`, and `Point`
