...
Use engine camera commands such as `panBy`, `setZoom`, and `zoomToFit`. Use the exported math helpers when application UI must convert between screen and board space.
