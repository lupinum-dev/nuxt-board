...
| Name                      | Type                                                         | Default        | Description                                                                                                                                          |
| ------------------------- | ------------------------------------------------------------ | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| `engine`                  | `BoardEngine \| null`                                        | `null`         | Engine instance. Defaults to the `BoardRoot` context. The component must still render under `BoardRoot` because it uses root DOM and camera context. |
...
Resolved defaults installed by `connectionPlugin()` and returned by `engine.ext.connections.getConfig()`.
