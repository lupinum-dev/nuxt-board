...
Treat the `engine` instance as stable after mount. To replace board contents, keep the same engine and load the new document through engine commands such as `importJSON`.
