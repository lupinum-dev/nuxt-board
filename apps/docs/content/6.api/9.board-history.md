...
The history plugin debounces rapid changes to avoid flooding the undo stack. Coalescable move and node-update commands within the debounce window are merged into one undo step. This means dragging a node produces one undo step, not hundreds.
