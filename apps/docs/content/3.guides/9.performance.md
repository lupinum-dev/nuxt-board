...
`BoardRoot` uses Vue's `v-memo` around layout-level node rendering. The memo dependencies include position, size, z-index, color, LOD, selection, and editing state.
::
