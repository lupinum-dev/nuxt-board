...
::field-group
::field{name="--board-bg" type="color" default="#fbfbfd"}
Page and panel background token used by the board UI.
::

::field{name="--board-canvas-bg" type="color" default="#f5f6fa"}
Canvas background behind nodes and overlays.
::

::field{name="--board-fg" type="color" default="#14161f"}
...
::field{name="--board-node-border" type="color" default="#e4e5ee"}
Default node border color.
::

::field{name="--board-accent" type="color" default="#6366e8"}
...
::field{name="--board-snap-guide-color" type="color" default="rgba(99, 102, 232, 0.95)"}
