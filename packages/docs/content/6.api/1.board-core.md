...
It does not expose the internal action replay system, reducers, reactive
subscribables, extension persistence hooks, or command inversion helpers as stable
consumer API.
...
extension installed fails instead of dropping edge data.
