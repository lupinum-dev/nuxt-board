...
function seed() {
  engine.importJSON(JSON.stringify({
    ...
    nodes: [
      { id: 'state-a', type: 'text', x: 70, y: 80, width: 220, height: 100, data: { content: 'Drag, resize, or\nselect this card' }, zIndex: 1, locked: false, visible: true },
      { id: 'state-b', type: 'text', x: 360, y: 180, width: 220, height: 100, data: { content: 'Hold Space to pan\nor box-select empty area' }, zIndex: 2, locked: false, visible: true }
    ],
    selection: [],
...
<template>
  <div class="demo-frame">
    <div class="demo-toolbar">
      ...
      <span class="demo-toolbar-note">Interact with the board and watch the mode change in the sidebar.</span>
    </div>
