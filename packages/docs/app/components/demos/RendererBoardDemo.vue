...
function seed() {
  engine.importJSON(JSON.stringify({
    ...
    nodes: [
      ...
      { id: 'metric', type: 'metric', x: 390, y: 90, width: 230, height: 160, data: { label: 'Adoption', value: '83%', delta: '+12%', caption: 'The renderer can look nothing like the default text card.' }, zIndex: 2, locked: false, visible: true },
      { id: 'flow', type: 'text', x: 660, y: 130, width: 230, height: 100, data: { content: 'Default text renderer\nmixed with custom ones' }, zIndex: 3, locked: false, visible: true }
    ],
    selection: [],
...
function addMetric() {
  engine.createNode({
    ...
    data: {
      ...
      value: '91%',
      delta: '+4%',
      caption: 'Different node types can have their own layout and visual language.'
    }
  })
}
...
<template>
  <div class="demo-frame">
    <div class="demo-toolbar">
      ...
      <button class="demo-primary" @click="addInsight">
        Add insight
      </button>
