...
.board-root {
  ...
  --board-box-select-fill: color-mix(
    in srgb,
    var(--ui-primary, #0f766e) 10%,
    transparent
  );
  --board-box-select-stroke: color-mix(
    in srgb,
    var(--ui-primary, #0f766e) 60%,
    transparent
  );
...
:global(.dark) .board-root {
  ...
  --board-box-select-fill: color-mix(
    in srgb,
    var(--ui-primary, #2dd4bf) 12%,
    transparent
  );
  --board-box-select-stroke: color-mix(
    in srgb,
    var(--ui-primary, #2dd4bf) 70%,
    transparent
  );
