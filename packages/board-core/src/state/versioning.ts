...
export interface StoredNode<TType extends string = string, TData extends NodeData = NodeData>
...
export function bumpVersions(prev: StoredNode, next: StoredNode): StoredNode {
  ...
  return {
    ...
    geometryVersion: geometryChanged ? prev.geometryVersion + 1 : prev.geometryVersion,
