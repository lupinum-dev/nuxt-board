...
function getConnections(engine: CanvasEngine): ConnectionApi {
  return engine.ext.connections as unknown as ConnectionApi
}

function replaceEdges(engine: CanvasEngine, edges: Array<Record<string, unknown>>): void {
...
export function loadDemoScene(engine: CanvasEngine, sceneId: DemoSceneId): DemoSceneOption {
...
export function exportDemoDocument(engine: CanvasEngine): string {
  return jsonCanvasSerializer.export(engine)
}

export function importDemoDocument(engine: CanvasEngine, json: string): void {
...
export function getDemoCounts(engine: CanvasEngine): {
  nodes: number
  edges: number
  selection: number
  history: number
...
export function wrapSelectionInGroup(engine: CanvasEngine): void {
...
export function getLastTraceLabel(engine: CanvasEngine): string {
