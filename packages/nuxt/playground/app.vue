...
import { CanvasConnectionLayer } from '@canvas/connections'
import { CanvasMinimap } from '@canvas/minimap'
import type { CanvasRendererRegistry } from '@canvas/vue'
...
useHead({
  title: '@canvas/nuxt playground',
  meta: [
    {
      name: 'description',
      content: 'A Nuxt SSR demo for @canvas/nuxt with deterministic seeded scenes, plugins, minimap, and JSON import/export.',
    },
  ],
})
  ...
  <main class="demo-shell">
    <section class="demo-hero">
      <div class="demo-hero__copy">
        ...
        <h1>Interactive canvas markup, rendered on the server before hydration.</h1>
    ...
    <section class="demo-stage-shell">
      ...
      <div class="demo-stage-grid">
        <section class="demo-canvas-shell">
          <CanvasRoot
            class="demo-canvas"
            :engine="engine"
            :grid="gridOptions"
          ...
          >
            ...
            <template #default="{ debugState }">
              ...
              <div v-if="showMinimap" class="demo-minimap">
                <CanvasMinimap :width="208" :height="148" />
              </div>
            </template>
          </CanvasRoot>
        </section>
...
:deep(.demo-canvas .canvas-node.is-selected) {
...
:deep(.demo-canvas .canvas-node__content),
:deep(.demo-canvas .canvas-node__editor) {
...
:deep(.demo-canvas .canvas-connection-layer) {
  color: rgba(14, 116, 144, 0.44);
}

:deep(.demo-canvas .canvas-node-handle) {
  border-radius: 4px;
